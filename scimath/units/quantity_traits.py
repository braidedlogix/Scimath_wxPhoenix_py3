...
def QuantityTrait(default_value,
                  units,
                  family_name,
                  auto_set=False,
                  display_units=None):
    ...
    return Trait(
        Quantity(
            default_value, units=units, family_name=family_name),
    ...
    def validate(self, object, name, value):
        try:
            if isinstance(value, Quantity):
                ...
                return Quantity(
                    value, units=units, family_name=self.family_name)
        except:
            pass
